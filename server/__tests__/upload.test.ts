...
function createTestPng(): Buffer {
  ...
  const png = Buffer.from([
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x02,
    0x00, 0x00, 0x00, 0x80, 0x16, 0xE3, 0x60, 0xEE, 0x3A, 0xF5,
    0xC9, 0x22, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4E, 0x44,
    0xAE, 0x42, 0x60, 0x82,
  ])
  return png
}
...
describe('Upload', () => {
  it('可上传真实 PNG 图片', async () => {
    ...
    expect(body.data.url).toContain('/uploads/images/')
  })
